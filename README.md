<h1 align="center">
  <span style="
    background: linear-gradient(90deg, #e63946, #ff7a7a);
...
- 📷 **[jetcam](https://github.com/zozaai/jetcam)** — Minimal, fast camera capture & streaming utilities for AI / CV pipelines.
- 🎙️ **[jetvoice](https://github.com/zozaai/jetvoice)** — Lightweight voice & audio tooling for AI apps (capture, stream, process).
- 🧩 **[MazeLLM](https://github.com/zozaai/MazeLLM)** — Maze-solving agent playground exploring tool-use, memory, and strategy with LLMs.
- 🧰 **[gitex](https://github.com/zozaai/gitex)** — Make repositories LLM-ready: dependency mapping, doc extraction, repo insights.
